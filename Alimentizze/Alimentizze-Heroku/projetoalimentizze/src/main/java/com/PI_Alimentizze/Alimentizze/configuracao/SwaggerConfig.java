package com.PI_Alimentizze.Alimentizze.configuracao;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors
						.basePackage("com.PI_Alimentizze.Alimentizze.controle"))
	...
	public static ApiInfo metadata() {
		...
		.title("API - Projeto Alimentizze")
		.description("Projeto API Spring - Projeto Alimentizze")
		.version("1.0.0")
		.license("Apache License Version 2.0")
		.licenseUrl("https://github.com/SuCastro/ProjetoAlimentizze")
		.contact(contact())
		.build();
	}
	
	private static Contact contact() {
		return new Contact("Projeto Alimentizze",
		"https://github.com/SuCastro/ProjetoAlimentizze",
		"alimentizze@gmail.com");
	}
